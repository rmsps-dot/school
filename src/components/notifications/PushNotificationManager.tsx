    ...
    try {
      if (isSubscribed) {
        ...
        if (permission !== 'granted') {
          setStatusMessage('Notification permission was denied.')
          setLoading(false)
          return
        }
    ...
    return (
      <button
        ...
        className={`p-2 rounded-xl transition-all border ${
          isSubscribed
            ? 'bg-veena-blue/20 border-veena-blue/40 text-veena-blue'
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-xs text-mist mt-0.5">
            Receive instant attendance, fee, and official school alerts on this device.
          </p>
          {statusMessage && (
