...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen w-full bg-[#0C0C0C] flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden font-kanit select-none"
    >
      {/* ── 4 Decorative Corner 3D Assets ── */}
      {/* Top-Left: Moon icon */}
      ...
      <div className="relative z-20 max-w-4xl w-full flex flex-col items-center">
        ...
        {/* Character-by-character scroll opacity text */}
